	...
	<div class="s_row">
		...
		<div class="s_col m7 s_padding">
			<div class="s_container s_card-2 s_white s_margin-bottom">
				<a href="create.php"> <p class=" s_round s_pink s_text-white" style="white-space:nowrap;"><i class="fa fa-500px fa-fw s_margin-right s_large s_text-white s_padding"></i> Create a new Workshop</p></a>
				<a href="edit.php"> <p class=" s_round s_red s_text-white" style="white-space:nowrap;"><i class="	fa fa-edit fa-fw s_margin-right s_large s_text-white s_padding"></i> Edit existing Workshop</p></a>
				<a href="data.php"> <p class=" s_round s_cyan s_text-white" style="white-space:nowrap;"><i class="fa fa-address-book fa-fw s_margin-right s_large s_text-white s_padding"></i> Check user data</p></a>
				<a href="team.php"> <p class=" s_round s_blue s_text-white" style="white-space:nowrap;"><i class="	fa fa-braille fa-fw s_margin-right s_large s_text-white s_padding"></i> Our Team</p></a>
